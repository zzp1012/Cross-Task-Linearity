...
class DTD:
    def __init__(self,
        ...
        self.train_dataset = datasets.DTD(root=location, split="train", transform=preprocess)
        ...
        self.test_dataset = datasets.DTD(root=location, split="val",transform=preprocess)
